<aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between hidden md:flex">
    <div>
        ...
        <nav class="p-4 space-y-1">
            ...
            <a href="{{ route('settings.index') }}" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
    <i class="fa-solid fa-gear w-5 h-5 mr-3 text-gray-500"></i>
    <span>Settings</span>
</a>
